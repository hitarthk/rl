...
class LinearSchedule(object):
    ...
    def update(self, t):
        ...
        delta = (self.eps_begin - self.eps_end) / self.nsteps
        self.epsilon = self.eps_begin - np.minimum(t, self.nsteps) * delta
...
class LinearExploration(LinearSchedule):
    ...
    def get_action(self, best_action):
        ...
        do_random = np.random.uniform(0, 1, 1)
        if (do_random <= self.epsilon):
